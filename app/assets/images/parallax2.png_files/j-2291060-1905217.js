...
(function(){
    ...
    getBackup: function(div) {
        ...
        div.innerHTML = '<a id="' + o.altImgID + '" href="' + href + '" target="' + o.altImgTarget + '"><img sr' + 'c="' + impression + '?' + o.random() + '" alt="' + o.altText + '" style="width:' + o.width + 'px; height:' + o.height + 'px; border:0px"/></a>';
        return div;
    },
    ...
    (function() {
    var p = "2291060", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2291060||'',
    GUID:window.ftGUID_2291060||'99999999999',
    confID:window.ftConfID_2291060||'0',
    ftReturn: window.ftReturn_2291060||'',
    keyword:window.ftKeyword_2291060||'',
    ftId:window.ftId_2291060||'',
    imp:window.ftImp2291060,
    ftImpId:window.ftImp2291060 && window.ftImp2291060.impID || '',
    campaignID:'72734',
    cID:'78496',
    pID:'2291060',
    creativeID:'1905217',
    exttrack:["https://ad.doubleclick.net/ddm/ad/N444803.288332ACCUEN/B10736340.143402936;sz=1x1;ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=?","https://aoa.demdex.net/event?d_event=imp&d_src=67324&d_site=4882&d_creative=1905217&d_placement=2291060&d_campaign=72734"],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/72734;2291060;1905217;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://aoa.demdex.net/event?d_event=click&d_creative=1905217&d_campaign=72734&d_placement=2291060&d_site=4882&d_rd=https://ad.doubleclick.net/ddm/clk/315411082;143402936;s?http://www.audioffers.com/?geoZip=[%FT_POSTAL%]","http://servedby.flashtalking.com/click/8/72734;2291060;1905217;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://aoa.demdex.net/event?d_event=click&d_creative=1905217&d_campaign=72734&d_placement=2291060&d_site=4882&d_rd=https://ad.doubleclick.net/ddm/clk/315411082;143402936;s?http://www.audioffers.com/"],
    placementDescription:'AudiPHDPTier2ERR7FY17DMBannerProspectingContextualAutoPaid1x1FlashtalkingNewYork300x250',
    width:300,
    height:250,
    ...
    divID:'ftdiv2291060',
    phID:'ftpos2291060',
    frameID:'ftframe2291060',
    expID:'ftexpframe2291060',
    altImgID:'ftalt2291060',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/72734;2291060;1905217;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://aoa.demdex.net/event?d_event=click&d_creative=1905217&d_campaign=72734&d_placement=2291060&d_site=4882&d_rd=https://ad.doubleclick.net/ddm/clk/315411082;143402936;s?http://www.audioffers.com/?geoZip=[%FT_POSTAL%]',
    altImg:'http://servedby.flashtalking.com/imp/8/72734;2291060;204;gif;Accuen;AudiPHDPTier2ERR7FY17DMBannerProspectingContextualAutoPaid1x1FlashtalkingNewYork300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/72734;2291060;271;pixel;Accuen;AudiPHDPTier2ERR7FY17DMBannerProspectingContextualAutoPaid1x1FlashtalkingNewYork300x250/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/8/72734;2291060;207;guid;Accuen;AudiPHDPTier2ERR7FY17DMBannerProspectingContextualAutoPaid1x1FlashtalkingNewYork300x250/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/229/2291060/1905217/js/j-2291060-1905217.js',
    file:'http://cdn.flashtalking.com/78496/1905217/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?91281187-2291060;1905217;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_2291060||'',
    segmentList:window.ftSegmentList_2291060||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2291060 && window.ftImp2291060.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2291060')&&/^https:/.test(document.getElementById('ftscript_m2291060').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2291060'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_2291060'],
        ['ftcfid', 'ftConfID_2291060'],
        ['fttime', 'ftTimestamp_2291060'],
        ['ftsection', 'ftSection_2291060'],
        ['ftcustom', 'ftCustom_2291060'],
        ['ft_id', 'ftId_2291060'],
        ['ftimpid','ftImp2291060', 'impID']
    ]
};
...
(function(o) {
    var clickSuf = (function() {
       ...
       for(var i = 0; i < c.length; i++){
            c[i] = c[i].replace("[%FT_POSTAL%]",window['ftPostal_' + o.pID]);
        }
  ...
  escapeMod = "3";
   ...
   if (clickSuf && clickSuf.indexOf("geoZip")>-1) {
...
//ftMinifiedft2291060.addVClick = function(ct) {    var pubClick = o.decode(o.qs('click', ''));    var encodeCount = o.encodeClickCount;    ct= ct.replace("[%FT_POSTAL%]",window['ftPostal_' + o.pID]);    if (pubClick && pubClick.indexOf("d.agkn.com") > -1 && pubClick.indexOf("insight.adsrvr.org") > -1 && pubClick.indexOf("adclick.g.doubleclick.net") > -1||pubClick.indexOf("insight.adsrvr.org") > -1) {        try {            var ft = ct.substr(0, ct.indexOf("https://aoa.demdex.net"));            var adobe = ct.substr(ct.indexOf("https://aoa.demdex.net"));            adobe = adobe.substr(0, adobe.indexOf("https://ad.doubleclick.net"));            var remain = ct.substr(ct.indexOf("https://ad.doubleclick.net"));            ct = adobe + encodeURIComponent(encodeURIComponent(ft + remain));        } catch (err) {}    }    if (encodeCount && pubClick) {        while (encodeCount--) {            ct = encodeURIComponent(ct);        }    } else if (pubClick && o.inApp) {        if (/^mopubnativebrowser:\/\//.test(pubClick)) {            ct = encodeURIComponent(encodeURIComponent(ct));        } else {            ct = encodeURIComponent(ct);        }    }    return pubClick + ct;};
